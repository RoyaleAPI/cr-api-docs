...
| Endpoint | URL | token |
| --- | --- | --- |
| clan | https://v3-beta.royaleapi.com/clan/2CCCP | `a1234.567.890` |

### cURL

```bash
curl --header "auth: a1234.567.890" https://v3-beta.royaleapi.com/clan/2CCCP
```

```bash
curl -X GET \
  https://v3-beta.royaleapi.com/clan/2CCCP \
...
```csharp
var client = new RestClient("https://v3-beta.royaleapi.com/clan/2CCCP");
...
Request request = new Request.Builder()
  .url("https://v3-beta.royaleapi.com/clan/2CCCP")
  .get()
...
```java
HttpResponse<String> response = Unirest.get("https://v3-beta.royaleapi.com/clan/2CCCP")
...
request('https://v3-beta.royaleapi.com/clan/2CCCP', {headers: {auth: 'a1234.567.890'}})
```
...
$test = file_get_contents("https://v3-beta.royaleapi.com/clan/2CCCP",true, $context);
```
...
$request->setUrl('https://v3-beta.royaleapi.com/clan/2CCCP');
...
$request->setRequestUrl('https://v3-beta.royaleapi.com/clan/2CCCP');
...
conn = http.client.HTTPConnection("v3-beta.royaleapi.com")
...
url = URI("https://v3-beta.royaleapi.com/clan/2CCCP")
...
let request = NSMutableURLRequest(url: NSURL(string: "https://v3-beta.royaleapi.com/clan/2CCCP")! as URL,
