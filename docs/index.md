...
We kept this online documentation as an archive of what we have done in the past. As we no longer provide a public API, you won’t be able to get a developer key anymore. If you’re looking to develope an application for Clash Royale, please use the [Official Clash Royale API from Supercell](https://developer.clashroyale.com).
